...
public class CeeiinTestContainer extends TestContainer {

    public CeeiinTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/ceeiin/app.properties",
    ...
    public static class Common extends CeeiinTestContainer {

        public static final CeeiinTestContainer.Common INSTANCE = new CeeiinTestContainer.Common();
